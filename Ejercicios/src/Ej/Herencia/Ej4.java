...
public class Ej4 {
    ...
    public static void main(String[] args) {
        Circulo C1 = new Circulo(55.0);
        System.out.println("El perimetro del Circulo es de " + C1.calcularPerimitro());
        System.out.println("El área del Circulo es de " + C1.calcularÁrea());
        Rectangulo R1 = new Rectangulo(20.0, 30.0);
        System.out.println("El perimetro del Rectangulo es de " + R1.calcularPerimitro());
        System.out.println("El área del Rectangulo es de " + R1.calcularÁrea());
    }
